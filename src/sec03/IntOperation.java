...
public class IntOperation {
	public static void main(String[] args) {
		...
		byte b = 10;
		short s = 20;
		int add = b + s; // 컴파일 오류(양쪽모두 int 타입으로 바뀌어서 연산, 결과도int 타입)
